...
COIN_TGZ='https://github.com/mogwaicoin/mogwai/releases/download/v0.12.2.3/mogwaicore-0.12.2.3-linux64.tar.gz'
COIN_ZIP='/root//mogwai/mogwaicore-0.12.2.3-linux64.tar.gz'
